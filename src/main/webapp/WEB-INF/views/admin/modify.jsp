	...
	<div class="container-md">
		<div class="row">
			<div class="col">
				...
				<h1>관리자 ${adminMember.adminMemberId } 정보 수정</h1>
				...
				<form id="modifyForm" action="" method="post" enctype="multipart/form-data">
					...
					<div class="mb-3">
						...
						<input readonly="readonly" type="text" class="form-control" value="${adminMember.authorityList }">
					</div>
					
					<%-- 이미지 출력 --%>
					<div class="mb-3">
						<label for="" class="form-label">이미지</label>
						<c:forEach items="${adminMember.fileList }" var="file" varStatus="status">
							<div class="row">
								<div class="col-2 d-flex justify-content-center align-items-center">
									<%-- 삭제 여부 체크박스 --%>
									
									<div class="form-check form-switch text-danger">
									  <input name="removeFiles" value="${file.name }" class="custom-check form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked${status.count }" >
					...
					<div class="mb-3">
						...
						<input multiple type="file" accept="image/*" class="form-control" name="addFiles">
...
document.querySelector(`#modifyForm input[name="addFiles"]`).addEventListener("change", function() {
	...
	// input:addFiles 에서 선택한 파일명들
	const files = document.querySelector(`#modifyForm input[name="addFiles"]`).files;
	console.log(files);
